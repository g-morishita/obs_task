# Options position and size
STIM_SLOT_POSITIONS = [(-0.25, 0), (0, 0), (0.25, 0)]
STIM_SIZE = (0.15, 0.15)

# Face position and size
FACE_SIZE = (0.15, 0.1)
FACE_SLOT_POSITION = (0, 0.2)
...
HIGHLIGHT_CHOSEN_GAP = (
    0.05  # size of the gap around each image, in norm units (adjust to taste)
)
HIGHLIGHT_LINE_WIDTH = 16
...
LAST_FIXATION_DURATION = 10.0  # seconds
